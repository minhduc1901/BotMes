...
●▬▬▬▬▬๑⇧⇧๑▬▬▬▬▬●
❛━━･❪ 𝑷𝒓𝒆𝒇𝒊𝒙 [!] ❫･━━❜
📲𝑴𝒐̣𝒊 𝒕𝒉𝒂̆́𝒄 𝒎𝒂̆́𝒄 𝒍𝒊𝒆̂𝒏 𝒉𝒆̣̂ 𝒂𝒅𝒎𝒊𝒏:https://www.facebook.com/minkduc191`, attachment: fs.createReadStream(__dirname + "/cache/joinGif/hello.mp4")} ,threadID));
  }
  else {
    try {
      ...
      const path = join(__dirname, "cache", "mv.gif");
